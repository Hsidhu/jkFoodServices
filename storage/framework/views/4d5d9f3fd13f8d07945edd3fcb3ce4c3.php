...
<?php if($showDeliveryCommentField): ?>
<div class="form-group">
    <label for="delivery_comment"><?php echo app('translator')->get('igniter.cart::default.checkout.label_delivery_comment'); ?></label>
    <textarea
        name="delivery_comment"
        id="delivery_comment"
        rows="3"
        class="form-control"
    ><?php echo set_value('delivery_comment', $order->delivery_comment); ?></textarea>
</div>
<?php endif; ?>
