<div
    ...
    data-price-amount="<?php echo e($cartItem ? $cartItem->price : $menuItem->price); ?>"
>
    <form method="POST" data-request="<?php echo e($formHandler); ?>">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><?php echo e($menuItem->name); ?></h4>
                <button
                    type="button"
            ...
            <div class="modal-body">
                <?php if(strlen($menuItem->description)): ?>
                    <p class="text-muted"><?php echo nl2br($menuItem->description); ?></p>
                <?php endif; ?>

                <input type="hidden" name="menuId" value="<?php echo e($menuItem->id); ?>"/>
                    ...
                    <div class="col-sm-5 pb-3 pb-sm-0">
                        <div class="input-group input-group-lg" data-toggle="quantity">
                            ...
                            <input
                                ...
                                value="<?php echo e($cartItem ? $cartItem->qty : 1); ?>"
                                min="0"
                                autocomplete="off"
                            >
                            <button
