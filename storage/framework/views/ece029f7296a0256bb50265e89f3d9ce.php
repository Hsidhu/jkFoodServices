<?php if($showLocalThumb && $locationCurrent->hasMedia('thumb')): ?>
    <img
...
<?php endif; ?>
<dl class="no-spacing">
    <dd><h1 class="h3"><?php echo e($locationCurrent->getName()); ?> - This is menu header</h1></dd>
    <?php if($showReviews): ?>
        <dd class="text-muted">
    ...
    <?php endif; ?>
    <dd>
        <span class="text-muted"><?php echo e(format_address($locationCurrent->getAddress(), false)); ?></span>
    </dd>
</dl>
