...
use Igniter\MealPlan\Classes\OrderManager;
...
class MealPlanCheckout extends BaseComponent
{
    use ValidatesForm;
    ...
    /**
     * @var \Igniter\MealPlan\Classes\OrderManager
     */
    protected $orderManager;

    /**
     * @var  \Igniter\MealPlan\Models\MealPlanOrder
     */
    protected $order;
    ...
    public function defineProperties()
    {
        return [
            ...
            'menusPage' => [
                ...
                'type' => 'select',
                'default' => 'local'.DIRECTORY_SEPARATOR.'mealplan',
            ...
            'successPage' => [
                ...
                'type' => 'select',
                'options' => [static::class, 'getThemePageOptions'],
                'default' => 'mealplancheckout'.DIRECTORY_SEPARATOR.'success',
                'validationRule' => 'required|regex:/^[a-z0-9\-_\/]+$/i',
            ],
            'cartBoxAlias' => [
