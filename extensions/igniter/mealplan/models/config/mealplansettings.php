...
return [
    'form' => [
        ...
        'rules' => [
            ['allow_mealplan', 'lang:igniter.local::default.reviews.label_allow_reviews', 'required|integer'],
            ['approve_mealplan', 'lang:igniter.local::default.reviews.label_approve_reviews', 'required|integer'],
