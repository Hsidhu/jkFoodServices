...
class Cart
{
    ...
    public function add($buyable, $qty = 0, array $options = [], $comment = null)
    {
        ...
        $this->putSession($this->sessionKey, $content);
    ...
    public function clearContent()
    {
        ...
        $this->session->pull(sprintf('cart.%s.%s', $this->instance, $this->sessionKey));
    ...
    {
        if (!$content = $this->getSession($this->sessionKey))
    ...
    public function store($identifier)
    {
        ...
        $cartStore->data = serialize([
            $this->sessionKey => $this->getContent(),
            'conditions' => $this->getConditions(),
        ]);
    ...
    public function restore($identifier)
    {
        ...
        $storedContent = array_get($storedData, $this->sessionKey);
